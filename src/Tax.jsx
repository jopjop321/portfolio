              ...
              <AnimatePresence>
                {Object.values(activeDeductions).some(Boolean) && (
                  ...
                  >
                    ...
                    {activeDeductions.ssf && activeDeductionCat === 'retirement' && <Input label={t.inputSsfAmount} value={deductionValues.ssfAmount} onChange={(e) => setDeductionValues({ ...deductionValues, ssfAmount: e.target.value })} placeholder="0" />}
