...
function Wealth() {
  return (
    ...
    <div className="min-h-screen bg-[#0B0E14] text-white selection:bg-[#C5A059] selection:text-black font-sans relative overflow-hidden">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pb-32 grid grid-cols-1 lg:grid-cols-2 gap-8">
          
          {/* เรียกใช้งาน Compound Interest Component ตรงนี้ */}
          <CompoundInterest />
          
          {/* Tax Shield Component จะมาวางตรงนี้ในเฟสต่อไป */}
